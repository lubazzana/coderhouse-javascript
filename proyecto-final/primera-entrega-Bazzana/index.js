let reservaUsuario = prompt("Ingresá tu nombre");
let reservaFecha = prompt("Ingresá la fecha de tu reserva");
let reservaPersonas = Number(prompt("Ingresá la cantidad de personas"));
alert(`${reservaUsuario} tu reserva para ${reservaPersonas} personas queda agendada para el día ${reservaFecha}`);
...
productos.push(new Producto("Tallarines", "Almuerzos y cenas", 400));
